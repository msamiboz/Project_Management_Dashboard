...
To model and understand delays in this dataset we modeled deep information about analysis can be found in the app link[]

#### Cost

Same as above for Costs paths I built a statistical model to understand relationship between other variables and costs. Deep explanation including interpretation can be found in link[]
