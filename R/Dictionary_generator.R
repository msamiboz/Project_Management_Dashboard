terms <- list(
  ...
  Phase= "Each seperate part of a project",
  KPI= "Key performance indicator",
  EDA= "Explotary data analysis",
  "CM,F&E" = "Construction Management, Furniture & Equipment – (Guessed)",
  "Construction" = "Main construction phase – (Guessed)",
  "Design" = "Architectural and engineering design – (Guessed)",
  "Purch & Install" = "Purchase and Installation – (Guessed)",
  "Scope" = "Scoping and pre-design – (Guessed)"
)
